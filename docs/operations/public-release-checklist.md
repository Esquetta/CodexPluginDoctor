...
- npm latest: codex-plugin-doctor@1.20.0
...
- Current release lane: `1.20.0` stable minor release verification
...
## 1.20.0 Minor Release Checklist
...
Before stable `1.20.0` publication:
