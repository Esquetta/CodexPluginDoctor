...
- npm latest: codex-plugin-doctor@1.19.0
...
- Current release lane: `1.19.0` stable minor release verification
...
## 1.19.0 Minor Release Checklist
...
Before stable `1.19.0` publication:
