...
- npm latest: codex-plugin-doctor@1.25.0
...
- Current release lane: `1.25.0` stable minor release verification
...
## 1.25.0 Minor Release Checklist
...
Before stable `1.25.0` publication:
