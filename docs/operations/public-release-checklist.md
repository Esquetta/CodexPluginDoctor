...
- npm latest: codex-plugin-doctor@1.21.0
...
- Current release lane: `1.21.0` stable minor release verification
...
## 1.21.0 Minor Release Checklist
...
Before stable `1.21.0` publication:
