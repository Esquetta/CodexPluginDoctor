...
- npm latest: codex-plugin-doctor@1.18.0
...
- Current release lane: `1.18.0` stable minor release verification
...
## 1.18.0 Minor Release Checklist
...
Before stable `1.18.0` publication:
