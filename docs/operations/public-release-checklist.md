...
- npm latest: codex-plugin-doctor@1.22.0
...
- Current release lane: `1.22.0` stable minor release verification
...
## 1.22.0 Minor Release Checklist
...
Before stable `1.22.0` publication:
