...
- npm latest: codex-plugin-doctor@1.12.0
...
- Current release lane: `1.12.0` stable minor release verification
...
## 1.12.0 Minor Release Checklist
...
Before stable `1.12.0` publication:
