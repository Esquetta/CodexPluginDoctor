...
- npm latest: codex-plugin-doctor@1.12.1
...
- Current release lane: `1.12.1` stable patch release verification
...
## 1.12.1 Patch Release Checklist
...
Before stable `1.12.1` publication:
