...
export async function buildWindsurfInstallPreview(
  targetPath: string,
  environment: CompatibilityEnvironment = {}
): Promise<WindsurfInstallPreview> {
...
export function renderWindsurfInstallPreview(preview: WindsurfInstallPreview): string {
  return [
